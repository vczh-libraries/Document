...
auto c = &X<int>::Method<double>;
		...
		auto recorder = BEGIN_ASSERT_SYMBOL
			...
			ASSERT_SYMBOL			(3, L"U", 15, 11, void, -1, -1)
			...
			ASSERT_SYMBOL			(12, L"B", 31, 19, void, -1, -1)
			ASSERT_SYMBOL			(13, L"X", 37, 0, ClassDeclaration, 2, 7)
			ASSERT_SYMBOL			(14, L"x", 38, 10, VariableDeclaration, 12, 7)
			ASSERT_SYMBOL			(15, L"Method", 38, 12, FunctionDeclaration, 10, 9)
			ASSERT_SYMBOL			(16, L"x", 39, 10, VariableDeclaration, 12, 7)
			ASSERT_SYMBOL			(17, L"Method", 39, 12, FunctionDeclaration, 10, 9)
			ASSERT_SYMBOL			(18, L"x", 40, 10, VariableDeclaration, 12, 7)
			ASSERT_SYMBOL			(19, L"X", 40, 12, ClassDeclaration, 2, 7)
			ASSERT_SYMBOL			(20, L"Method", 40, 20, FunctionDeclaration, 10, 9)
			ASSERT_SYMBOL			(21, L"x", 41, 10, VariableDeclaration, 12, 7)
			ASSERT_SYMBOL			(22, L"X", 41, 12, ClassDeclaration, 2, 7)
			ASSERT_SYMBOL			(23, L"Method", 41, 20, FunctionDeclaration, 10, 9)
			ASSERT_SYMBOL			(24, L"X", 42, 10, ClassDeclaration, 2, 7)
			ASSERT_SYMBOL			(25, L"Method", 42, 18, FunctionDeclaration, 10, 9)
			ASSERT_SYMBOL_OVERLOAD	(26, L"Method", 39, 12, ForwardFunctionDeclaration, 5, 4)
			ASSERT_SYMBOL_OVERLOAD	(27, L"Method", 41, 20, ForwardFunctionDeclaration, 5, 4)
		END_ASSERT_SYMBOL;
