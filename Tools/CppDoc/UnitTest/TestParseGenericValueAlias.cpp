...
using_value True: auto = true;
		...
		AssertExpr(pa, L"Size",				L"Size",				L"<::Size::[T]> unsigned __int32 const & $PR"	);
		AssertExpr(pa, L"Ctor",				L"Ctor",				L"<::Ctor::[T]> ::Ctor::[T] const & $PR"		);
		AssertExpr(pa, L"Id",				L"Id",					L"<::Id::[T], *> ::Id::[T] const & $PR"			);
		AssertExpr(pa, L"True",				L"True",				L"<::True::[], *> bool const & $PR"				);
	});
...
struct S
{
	...
	char operator*();
		...
		AssertExpr(pa, L"Id",												L"Id",														L"<::Id::[T], *> ::Id::[T] const & $PR"									);
		AssertExpr(pa, L"Parenthesis",										L"Parenthesis",												L"<::Parenthesis::[T], *> ::Parenthesis::[T] const & $PR"				);
		AssertExpr(pa, L"Cast",												L"Cast",													L"<::Cast::[T], ::Cast::[U], *> ::Cast::[U] const & $PR"				);
		AssertExpr(pa, L"Throw",											L"Throw",													L"<::Throw::[T], *> void const & $PR"									);
		AssertExpr(pa, L"New",												L"New",														L"<::New::[T], *> ::New::[T] * const & $PR"								);
		AssertExpr(pa, L"Delete",											L"Delete",													L"<::Delete::[T], *> void const & $PR"									);
		...
		AssertExpr(pa, L"If",												L"If",														L"<::If::[T], *> ::If::[T] const & $PR"									);

		AssertExpr(pa, L"Id<int, 0>",										L"Id<int, 0>",												L"__int32 const & $PR"													);
...
auto C = F(Value);
		...
		AssertExpr(pa, L"C",						L"C",							L"<::C::[T], *> __int32 * const & $PR",
																					L"<::C::[T], *> double * const & $PR",
																					L"<::C::[T], *> void const & $PR"		);

		AssertExpr(pa, L"C<int, nullptr>",			L"C<int, nullptr>",				L"__int32 * const & $PR"				);
		AssertExpr(pa, L"C<double, nullptr>",		L"C<double, nullptr>",			L"double * const & $PR"					);
		AssertExpr(pa, L"C<char, nullptr>",			L"C<char, nullptr>",			L"void const & $PR"						);
	});
...
auto Y = T::template Y<T>;
		...
		AssertExpr(pa, L"X<S>",						L"X<S>",							L"__int32 const & $PR"			);
		AssertExpr(pa, L"Y<S>",						L"Y<S>",							L"::S * const & $PR"			);
	});
