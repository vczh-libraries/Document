...
TEST_CASE(TestParseMember_Field_Qualifier)
{
	auto input = LR"(
struct X
{
...
TEST_CASE(TestParseMember_ArrayQualifier)
{
	auto input = LR"(
int x[1];
int (&lx)[1];
...
TEST_CASE(TestParseMember_FFA_Qualifier)
{
	auto input = LR"(
struct X
{
...
Symbol* TestParseMember_InsideFunction(const ParsingArguments& pa, const WString& className, const WString& methodName)
{
...
TEST_CASE(TestParseMember_FFA_Qualifier_OfExplicitOrImplicitThisExpr)
{
	auto input = LR"(
struct X
{
...
TEST_CASE(TestParseMember_AddressOfArrayFunctionMemberPointer)
{
	auto input = LR"(
struct X
{
...
TEST_CASE(TestParseMember_AddressOfMember_OfExplicitOrImplicitThisExpr)
{
	auto input = LR"(
struct S
{
...
TEST_CASE(TestParseMember_FieldReference)
{
	auto input = LR"(
struct A
{
