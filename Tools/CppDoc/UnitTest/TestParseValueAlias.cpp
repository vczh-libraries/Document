...
struct S
{
	...
	AssertExpr(L"Array<S*, nullptr>",								L"Array<S *, nullptr>",										L"::S $L",																		pa);
	...
	AssertExpr(L"Prefix<S, S()>",									L"Prefix<S< S()>",											L"<::Prefix::[T], *> {__int8 $PR, __int16 $PR, double $PR, char $PR} $PR",		pa);
	AssertExpr(L"Binary1<S, double S::*, S(), &S::field>",			L"Binary1<S, double (S ::) *, S(), (& S :: field)>",		L"double $L",																	pa);
	AssertExpr(L"Binary2<S*, double S::*, nullptr, &S::field>",		L"Binary2<S *, double (S ::) *, nullptr, (& S :: field)>",	L"double $L",																	pa);
