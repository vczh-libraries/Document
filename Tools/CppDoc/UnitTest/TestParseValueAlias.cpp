...
using If = Value ? Value : Value;
	...
	AssertExpr(L"Prefix",			L"Prefix",						L"<::Prefix::[T], *> {any_t $PR, any_t $PR, any_t $PR, any_t $PR, any_t $PR, any_t $PR, any_t $PR} $PR",	pa);
	AssertExpr(L"Binary",			L"Binary",						L"<::Binary::[T], ::Binary::[U], *, *> {any_t $PR, any_t $PR, any_t $PR, any_t $PR} $PR",					pa);
