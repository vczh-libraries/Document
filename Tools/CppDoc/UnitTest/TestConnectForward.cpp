...
TEST_CASE(TestConnectForward_Enums)
{
	auto input = LR"(
namespace a::b
{
...
TEST_CASE(TestConnectForward_Variables)
{
	auto input = LR"(
namespace a::b
{
...
TEST_CASE(TestConnectForward_Functions)
{
	auto input = LR"(
namespace a::b
{
...
TEST_CASE(TestConnectForward_Classes)
{
...
TEST_CASE(TestConnectForward_ClassMembers)
{
	auto input = LR"(
namespace a::b
{
