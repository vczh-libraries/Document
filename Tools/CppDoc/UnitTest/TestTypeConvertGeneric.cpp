...
TEST_FILE
{
	TEST_CATEGORY(L"Test type conversion with free generic argument")
	{
...
using Context = T;
		...
		TEST_CASE(L"Test anyInvolved flags")
		{
			for (vint i = 0; i < TypeCount; i++)
			{
				auto fromType = genericTypes[i];
