...
auto x8 = F<double>(L"GacUI", "GacUI", L'G', 'G');
		...
		auto recorder = BEGIN_ASSERT_SYMBOL
			...
			ASSERT_SYMBOL			(6, L"F", 19, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(7, L"F", 20, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(8, L"F", 21, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(9, L"F", 22, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(10, L"F", 23, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(11, L"F", 24, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(12, L"F", 25, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL			(13, L"F", 26, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(14, L"F", 19, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(15, L"F", 20, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(16, L"F", 21, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(17, L"F", 22, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(18, L"F", 23, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(19, L"F", 24, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(20, L"F", 25, 10, FunctionDeclaration, 0, 0)
			ASSERT_SYMBOL_OVERLOAD	(21, L"F", 26, 10, FunctionDeclaration, 0, 0)
		END_ASSERT_SYMBOL;
