...
namespace symbol_type_resolving
{
	...
	extern TypeTsysList&						EvaluateFuncSymbol(const ParsingArguments& invokerPa, ForwardFunctionDeclaration* funcDecl, ITsys* parentDeclType, TemplateArgumentContext* argumentsToApply, List<ResolvedItem>* ritems = nullptr);
	...
	extern TypeTsysList&						EvaluateValueAliasSymbol(const ParsingArguments& invokerPa, ValueAliasDeclaration* usingDecl, ITsys* parentDeclType, TemplateArgumentContext* argumentsToApply, List<ResolvedItem>* ritems = nullptr);
	...
	extern ITsys*								AdjustParentDeclType(ITsys* classType);
