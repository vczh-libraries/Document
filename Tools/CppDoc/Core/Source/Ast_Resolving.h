...
namespace symbol_type_resolving
{
	...
	extern void				VisitResolvedMember(const ParsingArguments& pa, Ptr<Resolving> resolving, ExprTsysList& result, GenericArgContext* gaContext, bool& hasVariadic, bool& hasNonVariadic);
